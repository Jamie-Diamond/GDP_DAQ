...
def viewer2():
    ...
    # Get data
    data = PP_data_import()
    accx, accy, accz, gyry, gyrx, gyrz, twa, cow, cog, hdg, sog, bsp, E, N, T, A = data_prep(data)
    fin = len(data)-1
    ...
    while idx < fin-samples:
        ...
        slimline_linar_var_plot([gyrz[idxS:idxF]], T[idxS:idxF], ['GYRZ'], thisfig, subfig=2)
...
def data_prep(data):
    ...
    accx, accy, accz, gyry, gyrx, gyrz, twa, cow, cog, hdg, sog, bsp, E, N, T, Acc = [], [], [], [], [], [], [], [], \
                                                                                     [], [], [], [], [], [], [], []
    for i in data:
        cog.append(i[1]['COG'])
        hdg.append(i[1]['HDG'])
        ...
        gyrz.append(i[1]['GYRZ'])
        gyry.append(i[1]['GYRY'])
        gyrx.append(i[1]['GYRX'])
        accx.append(i[1]['ACCX'])
        accy.append(i[1]['ACCY'])
        accz.append(i[1]['ACCZ'])
    print('\nData Ready')
    return accx, accy, accz, gyry, gyrx, gyrz, twa, cow, cog, hdg, sog, bsp, E, N, T, Acc
